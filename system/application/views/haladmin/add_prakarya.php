        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tambah info prakarya</h1>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class='fa fa-edit fa-fw'></i>&nbsp<b>Panel tambah info prakarya</b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Form tambah info prakarya</a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="home">
                                    <br><br>
                                    <?php echo form_open_multipart('admin_prakarya/proses_tambah_prakarya') ?>
                                    ...
                                    <div class="form-group">
                                        <label>Isi</label>
                                        <textarea class="form-control" rows="3" id="editor1" name="isi" required></textarea>
                                        <script>
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    foreach($gambar->result_array() as $g){
                                                        ...
                                                        echo "<td><a href='".base_url()."system/application/views/gambar/$g[nama_file].".$g['tipe_file']."' class='fancybox' data-fancybox-group='gallery' title='$g[nama_gambar]'>$g[nama_gambar]</a></td>";
                                                        echo "<td>$g[url]</td>";
                                                        echo "<td>$g[resolusi]</td>";
                                                        echo "<td><center>$tglPost</center></td>";
                                                        echo "<td><center><a href='".base_url()."admin_gambar/hapus_gambar/$g[id_gambar]' class='btn btn-danger btn-sm' onclick='return confirm(\"Anda ingin menghapus data ?\")'><i class='fa fa-times'></i>&nbsp hapus</a></center></td>";
                                                        $no++;
                                                        echo "</tr>";
                                                    }
                                                ?>
