        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit info mading</h1>
                        <div class="panel panel-primary">
                        	<div class="panel-heading">
                            	<i class='fa fa-edit fa-fw'></i>&nbsp<b>Panel edit info mading</b>
                       		</div>
                        	<div class="panel-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                    	<?php echo form_open_multipart('admin_mading/proses_edit_mading') ?>
