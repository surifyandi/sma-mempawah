        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    	<h1 class="page-header">Edit Prakarya</h1>
                        <div class="panel panel-primary">
                        	<div class="panel-heading">
                            	<i class='fa fa-edit fa-fw'></i>&nbsp<b>Panel edit prakarya</b>
                       		</div>
                        	<div class="panel-body">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#home" data-toggle="tab">Form edit prakarya</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                    	<?php echo form_open_multipart('admin_prakarya/proses_edit_prakarya') ?>
